...
namespace DataAccessLayer
{
    public static class MatrixIncDbInitializer
    {
        public static void Initialize(MatrixIncDbContext context)
        {
            ...
            {
                new Customer { Name = "Neo", Address = "123 Elm St" , Active=true, Password = "Neo123"},
                new Customer { Name = "Morpheus", Address = "456 Oak St", Active = true, Password = "Morpheus123" },
                new Customer { Name = "Trinity", Address = "789 Pine St", Active = true, Password = "Trinity123" }
            };
